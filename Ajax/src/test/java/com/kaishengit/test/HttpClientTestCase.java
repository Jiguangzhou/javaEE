...
public class HttpClientTestCase {
    ...
    public void testDownloadImage() throws IOException {
        ...
        if (httpCode == 200){
            ...
            FileOutputStream outputStream = new FileOutputStream("E:/qingxin.jpg");
            ...
            System.out.println("数据请求异常:"+hashCode());
        }
        httpClient.close();
    }
    @Test
    public void testGetRequest() throws IOException {
        ...
        CloseableHttpClient httpClient = HttpClients.createDefault();
        HttpGet httpGet = new HttpGet("http://blog.sina.com.cn/rss/1220218113.xml");//www.kaishengit.com
        HttpResponse httpResponse = httpClient.execute(httpGet);
