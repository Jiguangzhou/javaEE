...
<div class="container">
    ...
    <div class="well well-sm ">
        <form method="get" class="form-inline">
            <input type="text" placeholder="书籍名称" class="form-control" name="bookname" value="${bookname}">
    ...
    <table class="table table-bordered">
        ...
        <c:forEach items="${page.items}" var="book">
            <tr>
                ...
                <td>
                    <a href="/books/${book.id}" class="btn">修改</a>
                    <a href="javascript:;" rel="${book.id}" class="delLink btn">删除</a>
                </td>
            </tr>
        </c:forEach>
        </tbody>
